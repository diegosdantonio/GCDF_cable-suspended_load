...
%    plot3_surf(xLd(max(1,i-hist):i, 1), xLd(max(1,i-hist):i, 2), xLd(max(1,i-hist):i, 3), colorRed1, colorRed2, 2, '-');
            ...
            grid on; title({'Geometric Control and Differential Flatness of a Quadrotor UAV with a Cable-Suspended Load' , 'Koushil Sreenath, Taeyoung Lee, Vijay Kumar'});
            legend('','traj_L','traj_d');%axis equal;
